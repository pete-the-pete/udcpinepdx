/**
 * Free Chuck demo: drag the hearth temperature and watch the real chef cycle
...
// can reach transcendence (280°C ≈ 536°F).
const MIN_C = 20;
const MAX_C = 280;

export function ChuckDemo({ initialC }: { initialC: number }) {
  const [tempC, setTempC] = useState(Math.min(initialC, MAX_C));
    ...
    <div class="card demo">
      ...
      <div class="demo__controls">
        ...
        <input
          ...
          step={1}
          value={tempC}
          aria-label="Hearth temperature"
          onInput={(e) => setTempC(Number((e.target as HTMLInputElement).value))}
        />
        <div class="demo__hint">
          Drag the hearth temperature · frozen → thawing → active → hot → very&nbsp;hot. A 4°
